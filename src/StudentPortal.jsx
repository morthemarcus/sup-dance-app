...
const TRANSLATIONS = {
  en: {
    ...
    resetIt: "Reset it", forgotDesc: "Enter your email and your teacher will receive a reset request.",
    sendRequest: "Send Request", backToLogin: "← Back to login",
    ...
    connectionError: "Connection error. Please try again.", fillFields: "Please enter your email and password.",
    demoMode: "Demo mode — enter any email/password to explore",
    home: "Home", classes: "Classes", notes: "Notes", pay: "Pay", profile: "Profile",
    welcomeBack: "Welcome back 👋", balanceDue: "Balance due", payNow: "Pay now →",
    paid: "Paid", thanks: "Thanks!", upcomingClasses: "Upcoming Classes", viewAll: "View all",
    notEnrolled: "You're not enrolled in any classes yet.", notesFromTeacher: "Notes from Teacher",
    allNotes: "All notes", recentClasses: "Recent Classes",
    rsvpComing: "✓ I'm coming", rsvpNotComing: "✗ Not coming", rsvpMaybe: "⏳ I'll update soon",
    rsvpAttending: "attending", rsvpStatus: "Your RSVP:",
    rsvpAlert: (days) => `Class in ${days} day${days !== 1 ? "s" : ""} — please confirm!`,
    loadingClasses: "Loading your classes…",
    classSchedule: "Class Schedule", browseClasses: "Browse all classes and manage your enrollment",
    enrolled: "Enrolled", sessionsAttended: (n) => `You've attended ${n} session${n !== 1 ? "s" : ""} of this class.`,
    youreEnrolled: "✓ You're enrolled", unenroll: "Unenroll", registerClass: "Register for this class",
    noClasses: "No classes available right now.", next: "Next", perClass: "/class",
    teacherNotes: "Teacher Notes", feedbackDesc: "Personal feedback from your classes",
    noNotes: "No notes yet — they'll appear here after each class.", latest: "✦ Latest", note: "Note",
    payments: "Payments", billingDesc: "Your billing history and outstanding balance",
    totalOutstanding: "Total Outstanding", payViaStripe: "💳 Pay Now via Stripe",
    stripeSecure: "Secure payment processed by Stripe. You'll receive a receipt by email.",
    paymentHistory: "Payment History", classesAttended: (n) => `${n} class${n !== 1 ? "es" : ""} attended`,
    ...
    myProfile: "My Profile", profileUpdated: "✓ Profile updated",
    classesEnrolled: "Classes\nenrolled", sessionsThisYear: "Sessions\nthis year", totalSessions: "Total\nsessions",
    personalInfo: "Personal Info", edit: "Edit", phone: "Phone", emailLabel: "Email",
    birthday: "Birthday", memberSince: "Member since", emergencyContact: "Emergency contact",
    editProfile: "Edit Profile", name: "Name", phonePlaceholder: "+972-50-000-0000",
    emergencyPlaceholder: "Name — phone number", saveChanges: "Save Changes", cancel: "Cancel",
    myClasses: "My Classes", active: "Active", notEnrolledClasses: "Not enrolled in any classes.",
    signOut: "Sign Out", payment: "Payment",
    demoStripe: "Add your Stripe key in CONFIG.STRIPE_PUBLISHABLE_KEY to enable real payments.",
    paySecurely: "Pay Securely", simulatePayment: "Simulate Payment",
    stripeEncryption: "Powered by Stripe · 256-bit encryption", processingPayment: "Processing payment…",
    paymentConfirmed: "Payment confirmed!", received: (amount) => `₪${amount} received`,
    paymentFailed: "Payment failed. Please try again or contact your teacher.",
    days: ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],
    monthFormat: (mk) => { const [y,m]=mk.split("-"); return new Date(+y,+m-1,1).toLocaleString("en",{month:"long",year:"numeric"}); },
  ...
  he: {
    dir: "rtl",
    studentPortal: "פורטל תלמידות", email: "אימייל", password: "סיסמה",
    emailPlaceholder: "האימייל שלך", passwordPlaceholder: "••••••••",
    signIn: "כניסה", signingIn: "מתחברת…", forgotPassword: "שכחתי סיסמה",
    resetIt: "לאיפוס", forgotDesc: "הכניסי את האימייל שלך והמורה תקבל בקשת איפוס.",
    sendRequest: "שלח בקשה", backToLogin: "← חזרה להתחברות",
    resetSent: "בקשת האיפוס נשלחה — המורה תשלח לך סיסמה חדשה.",
    invalidCreds: "אימייל או סיסמה שגויים. פני למורה שלך להגדיר את החשבון.",
    connectionError: "שגיאת חיבור. נסי שוב.", fillFields: "נא להזין אימייל וסיסמה.",
    demoMode: "מצב הדגמה — הזיני כל אימייל/סיסמה לחקור",
    home: "בית", classes: "שיעורים", notes: "הערות", pay: "תשלום", profile: "פרופיל",
    welcomeBack: "ברוכה השבה 👋", balanceDue: "יתרה לתשלום", payNow: "שלמי עכשיו ←",
    paid: "שולם", thanks: "תודה!", upcomingClasses: "שיעורים הקרובים", viewAll: "הצג הכל",
    notEnrolled: "עוד לא נרשמת לאף שיעור.", notesFromTeacher: "הערות מהמורה",
    allNotes: "כל ההערות", recentClasses: "שיעורים אחרונים",
    rsvpComing: "✓ מגיעה", rsvpNotComing: "✗ לא מגיעה", rsvpMaybe: "⏳ אעדכן בקרוב",
    rsvpAttending: "מגיעים", rsvpStatus: "הסטטוס שלך:",
    rsvpAlert: (days) => `שיעור בעוד ${days} ${days === 1 ? "יום" : "ימים"} — אנא אשרי הגעה!`,
    loadingClasses: "טוענת את השיעורים שלך…",
    classSchedule: "מערכת שיעורים", browseClasses: "עיין בכל השיעורים ונהל את הרשמתך",
    enrolled: "רשומה", sessionsAttended: (n) => `השתתפת ב-${n} ${n===1?"מפגש":"מפגשים"} בשיעור זה.`,
    youreEnrolled: "✓ את רשומה", unenroll: "בטל רישום", registerClass: "הרשמה לשיעור",
    noClasses: "אין שיעורים זמינים כרגע.", next: "הבא", perClass: "לשיעור/",
    teacherNotes: "הערות מהמורה", feedbackDesc: "משוב אישי מהשיעורים שלך",
    noNotes: "אין הערות עדיין — הן יופיעו כאן אחרי כל שיעור.", latest: "✦ אחרונה", note: "הערה",
    payments: "תשלומים", billingDesc: "היסטוריית חיובים ויתרה לתשלום",
    totalOutstanding: "סה״כ לתשלום", payViaStripe: "💳 תשלום דרך Stripe",
    stripeSecure: "תשלום מאובטח דרך Stripe. תקבלי קבלה במייל.",
    paymentHistory: "היסטוריית תשלומים", classesAttended: (n) => `${n} ${n===1?"שיעור":"שיעורים"} בחודש`,
    ...
    myProfile: "הפרופיל שלי", profileUpdated: "✓ הפרופיל עודכן",
    classesEnrolled: "שיעורים\nרשומים", sessionsThisYear: "מפגשים\nהשנה", totalSessions: "סה״כ\nמפגשים",
    personalInfo: "פרטים אישיים", edit: "עריכה", phone: "טלפון", emailLabel: "אימייל",
    birthday: "יום הולדת", memberSince: "חברה מאז", emergencyContact: "איש קשר לחירום",
    editProfile: "ערוך פרופיל", name: "שם", phonePlaceholder: "050-000-0000",
    emergencyPlaceholder: "שם — מספר טלפון", saveChanges: "שמור שינויים", cancel: "ביטול",
    myClasses: "השיעורים שלי", active: "פעיל", notEnrolledClasses: "לא רשומה לאף שיעור.",
    signOut: "התנתק", payment: "תשלום",
    demoStripe: "הוסיפי את מפתח Stripe ב-CONFIG.STRIPE_PUBLISHABLE_KEY להפעלת תשלומים אמיתיים.",
    paySecurely: "תשלום מאובטח", simulatePayment: "סימולציית תשלום",
    stripeEncryption: "מופעל על ידי Stripe · הצפנה 256-bit", processingPayment: "מעבד תשלום…",
    paymentConfirmed: "התשלום אושר!", received: (amount) => `₪${amount} התקבל`,
    paymentFailed: "התשלום נכשל. נסי שוב או פני למורה.",
    days: ["ראשון","שני","שלישי","רביעי","חמישי","שישי","שבת"],
    monthFormat: (mk) => { const [y,m]=mk.split("-"); return new Date(+y,+m-1,1).toLocaleString("he",{month:"long",year:"numeric"}); },
...
const GAS = {
  async call(action, payload = {}) {
    ...
    try {
      const res = await fetch(CONFIG.GAS_URL, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ action, ...payload }) });
  ...
  async logPayment(studentId, amount, description, stripePaymentId) { return this.call("logPayment", { studentId, amount, description, stripePaymentId }); },
  async rsvp(studentId, classId, date, status) { return this.call("rsvp", { studentId, classId, date, status }); },
};
...
const DEMO_STUDENT = { id: "s1", name: "נועה כהן", phone: "050-1234567", email: "noa@example.com", birthday: "1995-03-15", joinDate: "2024-09-01", assignedClasses: ["c1","c2"], emergencyContact: "שרה כהן — 052-9876543", notes: "מתקדמת" };
...
const DEMO_PAYMENTS = { "s1-2026-02": { status: "unpaid" }, "s1-2026-01": { status: "paid" }, "s1-2025-12": { status: "paid" } };
...
function LangToggle({ compact = false }) {
  ...
  return (
    <button onClick={() => setLang(lang === "he" ? "en" : "he")}
      style={{ background: "transparent", border: `1px solid ${Tk.border}`, borderRadius: 8, color: Tk.textMuted, fontFamily: FONT, fontSize: compact ? 12 : 13, fontWeight: 700, padding: compact ? "4px 10px" : "6px 13px", cursor: "pointer", letterSpacing: 0.5, transition: "all 0.18s", flexShrink: 0 }}
...
function Avatar({ name, size = 44 }) {
  ...
  return <div style={{ width: size, height: size, borderRadius: "50%", flexShrink: 0, background: `linear-gradient(135deg, ${Tk.accent}, ${Tk.purple})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: size*0.32, fontWeight: 700, color: "#fff", fontFamily: FONT }}>{initials.toUpperCase()}</div>;
}

function Chip({ children, color = Tk.accent, style = {} }) {
  return <span style={{ display: "inline-flex", alignItems: "center", gap: 4, background: color+"22", color, border: `1px solid ${color}44`, borderRadius: 20, padding: "3px 11px", fontSize: 11, fontWeight: 600, fontFamily: FONT, whiteSpace: "nowrap", ...style }}>{children}</span>;
}
...
function Card({ children, style = {}, onClick }) {
  ...
  return (
    <div onClick={onClick} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{ background: Tk.card, border: `1px solid ${hov && onClick ? Tk.borderLight : Tk.border}`, borderRadius: 16, padding: 18, transform: hov && onClick ? "translateY(-1px)" : "none", boxShadow: hov && onClick ? "0 8px 32px rgba(0,0,0,0.4)" : "0 2px 8px rgba(0,0,0,0.2)", transition: "all 0.2s", cursor: onClick ? "pointer" : "default", ...style }}>
      {children}
    </div>
  );
}
...
function Btn({ children, onClick, variant = "primary", size = "md", style = {}, disabled = false }) {
  const [hov, setHov] = useState(false);
  const { t } = useLang();
  const base = { border: "none", borderRadius: 12, fontFamily: FONT, fontWeight: 600, cursor: disabled ? "not-allowed" : "pointer", transition: "all 0.18s", opacity: disabled ? 0.5 : 1, letterSpacing: 0.2, fontSize: size==="sm"?12:size==="lg"?16:14, padding: size==="sm"?"7px 14px":size==="lg"?"14px 28px":"11px 20px", display: "inline-flex", alignItems: "center", gap: 6, direction: t.dir, ...style };
  const vars = { primary: { background: hov?Tk.accentHover:Tk.accent, color: "#fff" }, ghost: { background: "transparent", border: `1px solid ${Tk.border}`, color: Tk.textMuted }, outline: { background: hov?Tk.accentDim:"transparent", border: `1px solid ${Tk.accent}`, color: Tk.accent }, success: { background: hov?"#16a34a":Tk.green, color: "#fff" }, subtle: { background: hov?Tk.border:"transparent", border: `1px solid ${Tk.border}`, color: Tk.text } };
  return <button onClick={onClick} disabled={disabled} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} style={{ ...base, ...vars[variant] }}>{children}</button>;
}
...
function Input({ label, value, onChange, type = "text", placeholder = "", style = {} }) {
  ...
  return (
    <div style={{ marginBottom: 16, ...style }}>
      {label && <label style={{ display: "block", color: Tk.textMuted, fontSize: 11, fontWeight: 600, marginBottom: 6, letterSpacing: 0.8, textTransform: "uppercase", fontFamily: FONT }}>{label}</label>}
      <input type={type} value={value} onChange={(e) => onChange(e.target.value)} placeholder={placeholder} onFocus={() => setFoc(true)} onBlur={() => setFoc(false)} dir={t.dir}
        style={{ width: "100%", boxSizing: "border-box", fontFamily: FONT, background: Tk.surface, border: `1px solid ${foc?Tk.accent:Tk.border}`, borderRadius: 10, padding: "12px 14px", color: Tk.text, fontSize: 15, outline: "none", transition: "border-color 0.2s", textAlign: t.dir==="rtl"?"right":"left" }} />
    </div>
  );
}
...
function BottomSheet({ title, onClose, children }) {
  const { t } = useLang();
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", zIndex: 300, backdropFilter: "blur(8px)", display: "flex", alignItems: "flex-end" }} onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} style={{ background: Tk.surface, borderRadius: "20px 20px 0 0", width: "100%", maxHeight: "90vh", overflowY: "auto", padding: "24px 20px 48px", boxShadow: "0 -24px 64px rgba(0,0,0,0.6)", animation: "sheetIn 0.3s cubic-bezier(0.4,0,0.2,1)", direction: t.dir }}>
...
function AuthScreen({ onLogin }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (gasResult?.ok) { onLogin(gasResult.student); }
      else if (!CONFIG.GAS_URL) { onLogin({ ...DEMO_STUDENT, email: email.trim(), _demo: true }); }
  ...
  return (
    <div dir={t.dir} style={{ minHeight: "100vh", background: Tk.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: FONT }}>
      <div style={{ position: "fixed", top: 20, [t.dir==="rtl"?"left":"right"]: 20, zIndex: 10 }}><LangToggle /></div>
      ...
      <div style={{ width: "100%", maxWidth: 380, animation: "fadeUp 0.5s ease" }}>
        ...
        {mode === "login" && (
          <Card>
            ...
            <Btn onClick={handleLogin} variant="primary" size="lg" style={{ width: "100%", justifyContent: "center" }} disabled={loading}>{loading ? t.signingIn : t.signIn}</Btn>
            <p style={{ textAlign: "center", color: Tk.textMuted, fontSize: 13, marginTop: 18, cursor: "pointer" }} onClick={() => setMode("forgot")}>{t.forgotPassword} <span style={{ color: Tk.accent }}>{t.resetIt}</span></p>
          </Card>
        )}
        {mode === "forgot" && (
          <Card>
            ...
            <Input label={t.email} type="email" value={email} onChange={setEmail} placeholder={t.emailPlaceholder} />
            <Btn onClick={() => { setMode("login"); setError(t.resetSent); }} style={{ width: "100%", justifyContent: "center" }}>{t.sendRequest}</Btn>
        ...
        {!CONFIG.GAS_URL && <p style={{ textAlign: "center", color: Tk.textDim, fontSize: 11, marginTop: 24 }}>{t.demoMode}</p>}
      </div>
    </div>
  );
}
...
function Dashboard({ student, classes, attendance, notes, payments, rsvps, onNavigate, onSync, syncing, onRsvp }) {
  ...
  return (
    <div style={{ padding: "0 0 100px" }}>
      <div style={{ background: `linear-gradient(160deg, ${Tk.accent}18 0%, ${Tk.purple}12 100%)`, borderBottom: `1px solid ${Tk.border}`, padding: "24px 20px 28px" }}>
        ...
        {payStatus !== "paid" && (
          <div onClick={() => onNavigate("payments")} style={{ marginTop: 20, background: `${Tk.accent}18`, border: `1px solid ${Tk.accent}44`, borderRadius: 14, padding: "14px 18px", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
      ...
      <div style={{ padding: "24px 20px 0" }}>
        <Section title={t.upcomingClasses} action={<span style={{ color: Tk.accent, fontSize: 13, cursor: "pointer" }} onClick={() => onNavigate("schedule")}>{t.viewAll}</span>}>
          ...
          {myClasses.map((c) => {
            ...
            const comingCount = Object.entries(rsvps || {}).filter(([k,v]) => k.includes(`-${c.id}-${nextDate}`) && v.status==="coming").length;
            const statusColor = myRsvp==="coming"?Tk.green:myRsvp==="not_coming"?Tk.danger:Tk.gold;
            const today = new Date(); today.setHours(0,0,0,0);
            const daysUntil = Math.ceil((new Date(nextDate) - today) / 86400000);
            const needsRsvp = daysUntil <= 5 && !myRsvp;

            return (
              <Card key={c.id} style={{ marginBottom: 12, border: `1px solid ${needsRsvp?Tk.danger:Tk.border}`, background: needsRsvp?`${Tk.danger}0d`:Tk.card }}>
                {needsRsvp && (
                  <div style={{ background: Tk.danger, borderRadius: 8, padding: "7px 12px", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ fontSize: 14 }}>⚠️</span>
                    <p style={{ color: "#fff", fontSize: 12, fontWeight: 700, margin: 0 }}>{t.rsvpAlert(daysUntil)}</p>
                  </div>
                )}
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <Btn size="sm" variant={myRsvp==="coming"?"success":"ghost"} onClick={() => onRsvp(c.id, nextDate, "coming")}>{t.rsvpComing}</Btn>
                  <Btn size="sm" variant="ghost" style={myRsvp==="not_coming"?{borderColor:Tk.danger,color:Tk.danger}:{}} onClick={() => onRsvp(c.id, nextDate, "not_coming")}>{t.rsvpNotComing}</Btn>
                  <Btn size="sm" variant="ghost" style={myRsvp==="maybe"?{borderColor:Tk.gold,color:Tk.gold}:{}} onClick={() => onRsvp(c.id, nextDate, "maybe")}>{t.rsvpMaybe}</Btn>
                </div>
              </Card>
            );
          })}
          ...
          <Card key={c.id} style={{ marginBottom: 14 }} onClick={() => setSelected(selected?.id===c.id?null:c)}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
              <div style={{ flex: 1 }}>
                ...
                <p style={{ color: Tk.textMuted, fontSize: 13, marginBottom: 4 }}>{t.days[DAYS_EN.indexOf(c.day)]} · {c.time}</p>
                <p style={{ color: Tk.textDim, fontSize: 12 }}>₪{c.pricePerClass}{t.perClass} · {t.next}: {nextOccurrence(c.day,t)}</p>
              </div>
...
function Notes({ notes }) {
  ...
  return (
    <div style={{ padding: "20px 20px 100px" }}>
      ...
      {sorted.length===0 && <div style={{ textAlign: "center", marginTop: 60 }}><div style={{ fontSize: 48, marginBottom: 16 }}>📝</div><p style={{ color: Tk.textMuted, fontSize: 15 }}>{t.noNotes}</p></div>}
      {sorted.map((n,i) => (
        <Card key={n.id} style={{ marginBottom: 14, borderLeft: t.dir==="ltr"?`3px solid ${i===0?Tk.gold:Tk.purple}`:"none", borderRight: t.dir==="rtl"?`3px solid ${i===0?Tk.gold:Tk.purple}`:"none" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
            <span style={{ color: i===0?Tk.gold:Tk.purple, fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.6 }}>{i===0?t.latest:t.note}</span>
...
function Payments({ student, classes, attendance, payments, onPayNow }) {
  ...
  const months = [];
  const now = new Date();
  for (let i=0;i<6;i++) { const d=new Date(now.getFullYear(),now.getMonth()-i,1); months.push(monthKey(d)); }
  const rows = months.map((mk) => ({ mk, status: payments[`${student.id}-${mk}`]?.status||"unpaid", cost: calcMonthCost(attendance,classes,mk), sessions: attendance.filter((a) => a.date.startsWith(mk)).length }));
...
function Profile({ student, classes, attendance, onUpdate, onLogout }) {
  ...
  const infoRows = [["📞",t.phone,student.phone||"—"],["✉️",t.emailLabel,student.email],["🎂",t.birthday,student.birthday||"—"],["📅",t.memberSince,student.joinDate?t.dateFormat(student.joinDate):"—"],["🆘",t.emergencyContact,student.emergencyContact||"—"]];
  return (
    <div style={{ padding: "20px 20px 100px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 28 }}>
        {[{label:t.classesEnrolled,value:myClasses.length},{label:t.sessionsThisYear,value:thisYear},{label:t.totalSessions,value:totalSessions}].map(({label,value}) => (
        ...
        <Card style={{ marginBottom: 16 }}>
          ...
          {infoRows.map(([icon,label,value]) => (
            <div key={label} style={{ display: "flex", gap: 12, padding: "10px 0", borderBottom: `1px solid ${Tk.border}` }}>
              ...
              <div><p style={{ color: Tk.textMuted, fontSize: 11, marginBottom: 2 }}>{label}</p><p style={{ color: Tk.text, fontSize: 14 }}>{value}</p></div>
            </div>
          ))}
        </Card>
      ) : (
      ...
      <Card style={{ marginBottom: 24 }}>
        ...
        {myClasses.map((c) => (
          <div key={c.id} style={{ display: "flex", justifyContent: "space-between", padding: "10px 0", borderBottom: `1px solid ${Tk.border}` }}>
            <div><p style={{ color: Tk.text, fontSize: 14, fontWeight: 500 }}>{c.name}</p><p style={{ color: Tk.textMuted, fontSize: 12 }}>{t.days[DAYS_EN.indexOf(c.day)]} · {c.time}</p></div>
            <Chip color={Tk.green}>{t.active}</Chip>
          </div>
        ))}
      </Card>
      <Btn variant="ghost" style={{ width: "100%", justifyContent: "center", color: Tk.danger, borderColor: Tk.danger+"44" }} onClick={onLogout}>{t.signOut}</Btn>
    </div>
  );
}
...
function PaymentModal({ amount, description, onClose, onSuccess }) {
  ...
  const handlePay = async () => {
    setStep("processing");
    try { await new Promise((r) => setTimeout(r,1800)); setStep("done"); setTimeout(onSuccess,1000); }
    catch { setError(t.paymentFailed); setStep("confirm"); }
  };
  return (
    <BottomSheet title={t.payment} onClose={onClose}>
      {step==="confirm" && (
        <>
          ...
          {!CONFIG.STRIPE_PUBLISHABLE_KEY && <div style={{ background: Tk.goldDim, border: `1px solid ${Tk.gold}44`, borderRadius: 10, padding: "12px 14px", marginBottom: 20 }}><p style={{ color: Tk.gold, fontSize: 12, lineHeight: 1.6 }}>{t.demoStripe}</p></div>}
          <Btn variant="primary" size="lg" style={{ width: "100%", justifyContent: "center" }} onClick={handlePay}>💳 {CONFIG.STRIPE_PUBLISHABLE_KEY?t.paySecurely:t.simulatePayment}</Btn>
          <p style={{ color: Tk.textDim, fontSize: 11, textAlign: "center", marginTop: 14 }}>{t.stripeEncryption}</p>
        </>
      )}
      {step==="processing" && <div style={{ textAlign: "center", padding: "40px 0" }}><div style={{ fontSize: 48, marginBottom: 16, animation: "spin 1s linear infinite", display: "inline-block" }}>⟳</div><p style={{ color: Tk.text, fontSize: 15 }}>{t.processingPayment}</p></div>}
      {step==="done" && <div style={{ textAlign: "center", padding: "40px 0" }}><div style={{ fontSize: 56, marginBottom: 16 }}>✅</div><p style={{ color: Tk.green, fontSize: 18, fontWeight: 700, marginBottom: 6 }}>{t.paymentConfirmed}</p><p style={{ color: Tk.textMuted, fontSize: 14 }}>{t.received(amount)}</p></div>}
    </BottomSheet>
  );
}

// ─────────────────────────────────────────────────────────────────────────────
// BOTTOM NAV — עם נקודה אדומה גם על Home אם יש RSVP pending
// ─────────────────────────────────────────────────────────────────────────────
function BottomNav({ active, onChange, payAlert, rsvpAlert }) {
  const { t } = useLang();
  const nav = [
  ...
  return (
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 100, background: Tk.surface, borderTop: `1px solid ${Tk.border}`, display: "flex", backdropFilter: "blur(12px)", paddingBottom: "env(safe-area-inset-bottom, 0px)", direction: t.dir }}>
      {items.map((n) => {
        const isActive = active===n.id;
        const hasAlert = (n.id==="payments" && payAlert) || (n.id==="dashboard" && rsvpAlert);
        return (
          <button key={n.id} onClick={() => onChange(n.id)} style={{ flex: 1, background: "none", border: "none", cursor: "pointer", padding: "10px 4px 12px", display: "flex", flexDirection: "column", alignItems: "center", gap: 3, position: "relative" }}>
            ...
            {hasAlert && <div style={{ position: "absolute", top: 6, right: "calc(50% - 14px)", width: 8, height: 8, borderRadius: "50%", background: Tk.danger, border: `2px solid ${Tk.surface}` }} />}
          </button>
        );
      })}
    </div>
...
export default function StudentApp() {
  const [lang, setLangState] = useState(() => { try { return localStorage.getItem("sup_lang")||"he"; } catch { return "he"; } });
  const setLang = (l) => { setLangState(l); try { localStorage.setItem("sup_lang",l); } catch {} };
  const t = TRANSLATIONS[lang];

  // ── כניסה אוטומטית — auth נשמר ב-localStorage ──
  const [auth, setAuth] = useState(() => { try { return JSON.parse(localStorage.getItem("sup_student_auth"))||null; } catch { return null; } });
  ...
  const loadData = useCallback(async () => {
    ...
    if (CONFIG.GAS_URL) {
      ...
      setStudioData({ classes: DEMO_CLASSES, students: [DEMO_STUDENT], attendance: { s1: DEMO_ATTENDANCE }, notes: { s1: DEMO_NOTES }, payments: DEMO_PAYMENTS });
    }
    setSyncing(false);
  }, []);

  // טוען נתונים אוטומטית — גם אם הlogin שמור מפגישה קודמת
  ...
  // האם יש שיעור ב-5 ימים הקרובים ללא RSVP → נקודה אדומה על Home
  const rsvpAlert = !!(student && classes.some((c) => {
    if (!student.assignedClasses?.includes(c.id)||c.archived) return false;
    const nextDate = nextOccurrenceDate(c.day);
    const today = new Date(); today.setHours(0,0,0,0);
    const daysUntil = Math.ceil((new Date(nextDate)-today)/86400000);
    return daysUntil<=5 && !rsvps[`${auth?.id}-${c.id}-${nextDate}`]?.status;
  }));
  ...
  const screenTitles = { schedule: t.classSchedule, notes: t.teacherNotes, payments: t.payments, profile: t.myProfile };
  ...
  return (
    <LangContext.Provider value={ctxValue}>
      ...
      <div dir={t.dir} style={{ minHeight: "100vh", background: Tk.bg, fontFamily: FONT, maxWidth: 480, margin: "0 auto", position: "relative" }}>
        <div style={{ minHeight: "100vh", animation: "fadeUp 0.3s ease" }} key={`${screen}-${lang}`}>
          {screen==="dashboard" && (
            <Dashboard student={student} classes={classes} attendance={myAttendance}
              ...
              onRsvp={(classId, date, status) => {
                // Optimistic UI — עדכון מיידי
                const key = `${auth.id}-${classId}-${date}`;
                setStudioData(prev => ({ ...prev, rsvps: { ...(prev?.rsvps||{}), [key]: { status, updatedAt: new Date().toISOString() } } }));
                // שמירה ברקע
          ...
          {screen==="notes" && <><Header title={screenTitles.notes} /><Notes notes={myNotes} /></>}
          {screen==="payments" && (
        ...
        <BottomNav active={screen} onChange={setScreen} payAlert={payAlert} rsvpAlert={rsvpAlert} />
        {payModal && (
          <PaymentModal amount={payModal.amount} description={payModal.description}
            onClose={() => setPayModal(null)}
            onSuccess={async () => { await GAS.logPayment(auth.id,payModal.amount,payModal.description,"stripe_demo"); setPayModal(null); await loadData(); }} />
        )}
      </div>
    </LangContext.Provider>
  );
